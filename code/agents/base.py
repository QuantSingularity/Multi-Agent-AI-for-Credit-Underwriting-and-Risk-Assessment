...
class BaseAgent(ABC):
    ...
    def send_message(self, receiver: str, msg_type: str, content: Dict[str, Any]) -> AgentMessage:
    ...
    def receive_message(self, message: AgentMessage) -> None:
        ...
        self.logger.info(f"Received {message.msg_type} from {message.sender}: {message.message_id}")
