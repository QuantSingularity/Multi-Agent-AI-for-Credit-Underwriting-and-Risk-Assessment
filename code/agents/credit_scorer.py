...
class CreditScoringAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str = "credit_scorer", config: Optional[Dict[str, Any]] = None):
    ...
    def _extract_features(self, application: ApplicationData) -> Dict[str, float]:
        ...
        features = {
            ...
            "loan_to_income": financial.get("loan_amount", 10000) / max(financial.get("annual_income", 50000), 1),
